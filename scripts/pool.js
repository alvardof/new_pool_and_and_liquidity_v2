...
async function main()
{
    ...
    console.log('pairAddres', pairAddress)
    ...
    const approval1 = await usdt.approve(router.address,ethers.constants.MaxInt256)
    approval1.wait()
    const approval2 = await usdc.approve(router.address,ethers.constants.MaxInt256)
    approval2.wait()
